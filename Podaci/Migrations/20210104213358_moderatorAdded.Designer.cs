...
namespace Podaci.Migrations
{
    ...
    [Migration("20210104213358_moderatorAdded")]
    partial class moderatorAdded
    {
            ...
            modelBuilder.Entity("Podaci.EntityModels.Administrator", b =>
                {
                    b.HasOne("Podaci.EntityModels.Korisnik", "Korisnik")
                        ...
                        .HasForeignKey("Podaci.EntityModels.Administrator", "KorisnikID");
                });
            ...
            modelBuilder.Entity("Podaci.EntityModels.Moderator", b =>
                {
                    b.HasOne("Podaci.EntityModels.Korisnik", "Korisnik")
                        .WithOne("Moderator")
                        .HasForeignKey("Podaci.EntityModels.Moderator", "KorisnikID");
                });
            ...
            modelBuilder.Entity("Podaci.EntityModels.Posjetilac", b =>
                {
                    b.HasOne("Podaci.EntityModels.Korisnik", "Korisnik")
                        .WithOne("Posjetilac")
                        .HasForeignKey("Podaci.EntityModels.Posjetilac", "KorisnikID");
                });
